...
@section('content')
	...
	<!--------------------- ABRE PADECIMIENTOS --------------------->
	<section class="descripcion-padecimiento erge">
		<div class="wrapt-descripcion-padecimiento">
			...
			<article>
				<div class="sintomas visible">
					<p> Algunos signos y síntomas frecuentes de la enfermedad por reflujo gastroesofágico son los siguientes:</p>
					<ul>
						<li>Una sensación de ardor en el pecho (ardor de estómago), generalmente después de comer, que podría empeorar por la noche.</li>
						<li>Dolor en el pecho.</li>
						<li>Dificultad para tragar.</li>
						<li>Regurgitación de alimentos o líquidos amargos.</li>
						<li>Sensación de tener un nudo en la garganta.</li>
					</ul>
				</div>
				<div class="causas">
