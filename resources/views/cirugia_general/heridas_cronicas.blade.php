...
@section('content')
	...
	<section class="descripcion-cirugia">
		<div class="wrapt-descripcion-cirugia">
			<div class="video">
				<img src="../img/servicios/herida-cronica.jpg" alt="">
			</div>
			<div class="texto-descripcion-cirugia">
				<h2>¿Qué es una herida crónica?</h2>
				<p>Una herida crónica se define como una pérdida de continuidad de la superficie epitelial con pérdida de sustancia con escasa o nula tendencia a la curación espontánea y que requiere períodos muy prolongados para su cicatrización por segunda intención.</p>
			</div>
		</div>
	</section>
	...
	<section class="beneficios-cirugia">
		<div class="wrapt-beneficios-cirugia">
			<h2>Tratamiento de heridas crónicas</h2>

			<article>
				<h3>Prevención y tratamiento de infecciones</h3>
				<p>Para reducir el recuento de bacterias en las heridas, los terapeutas pueden usar antibióticos tópicos, que matan las bacterias y también pueden ayudar a mantener el entorno de la herida húmedo, que es importante para acelerar la curación de heridas crónicas.</p>
			</article>
			<article>
				<h3>Isquemia e hipoxia</h3>
				<p>Los vasos sanguíneos se contraen en el tejido que se enfría y se dilatan en el tejido caliente, lo que altera el flujo de sangre al área. Por lo tanto, mantener los tejidos a temperatura optima es probablemente necesario para combatir tanto la infección como la isquemia.</p>
			</article>
			<article>
				<h3>Factores de crecimiento y hormonas</h3>
				<p>Como las heridas crónicas expresan en menor medida los factores de crecimiento necesarios para la cicatrización del tejido, la cicatrización de las heridas crónicas se puede acelerar reemplazando o estimulando esos factores y previniendo la formación excesiva de proteasas como la elastasa que las descompone.</p>
			</article>
		</div>
	</section>
	<!--------------------- CIERRA DESCRIPCIÓN CIRUGÍA --------------------->
			...
			<div class="preguntas-frecuentes">
				...
				<ul class="accordion">
					<li>
				    	...
				    	<ul class="inner">
				      		<li>El costo de la consulta es de $700.00, si agendas aquí antes del 20 de septiembre de 2019 tendrás en 15% de descuento en tu primer consulta. </li>
