...
@section('content')
	...
	<section class="slide-servicios">
		<div class="texto-slide">
			<div>
				<h1>No más dolor</h1>
				<p>Cirugía de vesícula biliar (colecistectomía)</p>
				<p>agenda hoy y obtén un <br><strong>¡descuento en tu primer consulta!</strong></p>
			</div>
		</div>
		<figure><img src="../img/portada-colecistectomia.jpg" alt=""></figure>
	</section>
	<!--------------------- CIERRA SLIDE --------------------->
	...
	<section class="descripcion-cirugia">
		<div class="wrapt-descripcion-cirugia">
			<div class="video">
				<img src="../img/servicios/vesicula.png" alt="">
			</div>
			<div class="texto-descripcion-cirugia">
				<h2>¿Qué es y cómo se realiza la colecistectomía?</h2>
				<p>La colecistectomía es un procedimiento quirúrgico para extirpar la vesícula biliar, un órgano con forma de pera que se encuentra justo debajo del hígado, en la parte superior derecha del abdomen. La vesícula biliar recoge y almacena la bilis, un jugo digestivo producido en el hígado.</p>
			</div>
		</div>
	</section>
	 ...
	 <section class="paquetes-quirurgicos">
		<div class="wrapt-paquetes-quirurgicos">
			<div class="texto-intro-paquetes">
				<h2>Nuestros paquetes quirúrgicos</h2>
				<p>Nuestra cirugía de vesícula cuenta con un paquete integral a un precio accesible para que puedas gozar de la salud que mereces. De igual forma trabajamos con los mejores hospitales de la ciudad de Veracruz y financieras que faciltan tus pagos.</p>
			</div>
			<article class="paquete">
				<h3>cirugía laparoscópica</h3>
	
					<p>Honorarios Médicos + Hospitalización + Quirofano.</p>
					
				<div class="precio-paquete">
					<p><small>Desde</small> <br><strong>$33,600.00</strong></p>
				</div>
			</article>
