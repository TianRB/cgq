...
<!--------------------- ABRE SLIDE --------------------->
	...
	<section class="descripcion-cirugia">
		<div class="wrapt-descripcion-cirugia">
			<div class="video">
				<img src="../img/servicios/tratado_ulceras.png" alt="">
			</div>
			<div class="texto-descripcion-cirugia">
				<h2>¿Qué son las úlceras por decúbito?</h2>
				<p>Las úlceras por decúbito (también llamadas «úlceras de presión» o «escaras») son lesiones de la piel y del tejido que se encuentra debajo, que se producen como resultado de una presión prolongada sobre la piel. En la mayoría de los casos, las úlceras por decúbito se manifiestan en la piel que recubre las partes óseas del cuerpo, como los talones, los tobillos, las caderas y el coxis.</p>
			</div>
		</div>
	</section>
	...
	<section class="beneficios-cirugia">
		<div class="wrapt-beneficios-cirugia">
			<h2>Tratamiento de úlceras por decubito</h2>

			<article>
				<h3>Reducción de la presión</h3>
				<p>El primer paso del tratamiento de una úlcera por decúbito es reducir la presión y la fricción que la provocaron.</p>
			</article>
			<article>
				<h3>Limpieza y vendaje de las heridas</h3>
				<p>La atención de las úlceras por presión depende de cuán profunda sea la herida.</p>
			</article>
			<article>
				<h3>Extracción del tejido dañado</h3>
				<p>Para curarse adecuadamente, las heridas tienen que estar libres de tejido dañado, muerto o infectado.</p>
			</article>
		</div>
	</section>
	<!--------------------- CIERRA DESCRIPCIÓN CIRUGÍA --------------------->
