...
@section('content')
	...
	<section class="slide-servicios">
		<div class="texto-slide">
			<div>
				<h1>Cirugía de Acalasia</h1>
				<p>Vuelve a comer con tranquilidad</p>
				<p>agenda hoy y obtén un <br><strong>¡descuento en tu primer consulta!</strong></p>
			</div>
		</div>
		<figure><img src="../img/portada-acalasia.jpg" alt=""></figure>
	</section>
	<!--------------------- CIERRA SLIDE --------------------->
	...
	<section class="descripcion-cirugia">
		<div class="wrapt-descripcion-cirugia">
			<div class="video">
				<img src="../img/servicios/acalasia.jpg" alt="">
			</div>
			<div class="texto-descripcion-cirugia">
				<h2>¿Qué es la Acalasia?</h2>
				<p>La acalasia es un trastorno poco frecuente del esófago que puede presentarse a cualquier edad. Se produce por la incapacidad del esófago de contraerse de forma normal y empujar el alimento hasta el estómago por la falta de relajación del esfínter esofágico inferior que impide el correcto paso de los alimentos al estómago.</p>
			</div>
		</div>
	</section>
	...
	<section class="beneficios-cirugia">
		<div class="wrapt-beneficios-cirugia">
			<h2>Opciones quirúrgicas en cirugía de acalasia</h2>

			<article>
				<h3>Miotomía de Heller</h3>
				<p>El cirujano corta el músculo en el extremo inferior del esfínter esofágico para permitir que los alimentos pasen con mayor facilidad al estómago. Este procedimiento se puede realizar de un modo no invasivo (miotomía de Heller laparoscópica). </p>
			</article>
			
			<article>
				<h3>Miotomía endoscópica por vía oral</h3>
				<p>El cirujano inserta un endoscopio a través de la boca y lo hace pasar por la garganta para hacer una incisión en el revestimiento interno del esófago. Después, al igual que en una miotomía de Heller, el cirujano corta el músculo en el extremo inferior del esfínter esofágico. </p>
			</article>
		</div>
	</section>
	<!--------------------- CIERRA DESCRIPCIÓN CIRUGÍA --------------------->
