...
@section('content')
	...
	<section class="descripcion-cirugia">
		<div class="wrapt-descripcion-cirugia">
			<div class="video">
				<img src="../img/servicios/reconeccionescolonicas.png" alt="">
			</div>
			<div class="texto-descripcion-cirugia">
				<h2>¿Qué son las reconexciones intestinales?</h2>
				<p>es una cirugía para reconectar su colon (intestino grueso) intestino delgado con su remanente intestinal después de una colostomía o ileostomia previa. Una colostomía es una abertura en el abdomen para drenar la materia fecal en una bolsa.</p>
			</div>
		</div>
	</section>
	...
	<section class="beneficios-cirugia">
		<div class="wrapt-beneficios-cirugia">
			...
			<article>
				<h3>Análisis</h3>
				<p>La preparación prequirúrgica incluye análisis de sangre, evaluación médica, radiografía de tórax, radiografía de la anatomia del intestino y un electrocardiograma dependiendo de su edad y su condición médica.</p>
			</article>
			<article>
				<h3>Limpiar el intestino</h3>
				<p>El intestino delgado y el colon deben evacuarse por completo antes de la cirugía. Por lo general, el paciente debe beber una solución especial para limpiar el intestino.</p>
			</article>
			<article>
				<h3>Suspensión de ciertos fármacos</h3>
				<p>Fármacos tales como aspirina, anticoagulantes, antiinflamatorios (medicamentos para la artritis) y vitamina E deben suspenderse en forma provisoria durante varios días y hasta una semana antes de la cirugía.</p>
			</article>
		</div>
	</section>
	<!--------------------- CIERRA DESCRIPCIÓN CIRUGÍA --------------------->
