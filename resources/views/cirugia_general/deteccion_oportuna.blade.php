...
@section('content')
	...
	<section class="slide-servicios">
		<div class="texto-slide">
			<div>
				<h1>Detección oportuna de cáncer de tubo digestivo</h1>
				<p>Actúa a tiempo para ganar la batalla</p>
				<p>agenda hoy y obtén un <br><strong>¡descuento en tu primer consulta!</strong></p>
			</div>
		</div>
		<figure><img src="../img/portada-deteccion-cancer.jpg" alt=""></figure>
	</section>
	<!--------------------- CIERRA SLIDE --------------------->
	...
	<section class="descripcion-cirugia">
		<div class="wrapt-descripcion-cirugia">
			<div class="video">
				<img src="../img/servicios/deteccion-cancer-tubo-digestivo.jpg" alt="">
			</div>
		
			<div class="texto-descripcion-cirugia">
				<h2>¿Cómo se realiza esta detección?</h2>
				<p>Para detectar y diagnosticar esta enfermedad se utilizan múltiples exámenes de laboratorio de gabinete y procedimientos endoscópicos, los cuales tienen como objetivo detectar de forma temprana, alguna lesión sospechosa de malignidad y en este caso ofrecer un tratamiento oportuno.</p>
			</div>
		</div>
	</section>
