...
@section('content')
	...
	<section class="slide-servicios">
		<div class="texto-slide">
			<div>
				<h1>Apendicectomía</h1>
				<p>Actúa rápido ante esta emergencia</p>
				<p>agenda hoy y obtén un <br><strong>¡descuento en tu primer consulta!</strong></p>
			</div>
		</div>
		<figure><img src="../img/portada-apendicitis.jpg" alt=""></figure>
	</section>
	<!--------------------- CIERRA SLIDE --------------------->
	...
	<section class="descripcion-cirugia">
		<div class="wrapt-descripcion-cirugia">
			<div class="video">
				<img src="../img/servicios/apendicectomia.jpg" alt="">
			</div>

			<div class="texto-descripcion-cirugia">
				<h2>¿Qué es y cómo se realiza la apendicectomía?</h2>
				<p>La apendicectomía es la técnica quirúrgica por medio de la cual se extrae el apéndice (apéndice cecal, vermiforme o vermicular), habitualmente en casos de apendicitis aguda. Este procedimiento puede realizarse por una vía de acceso "abierta, convencional" (se accede a la cavidad abdominal a través de la clásica incisión o herida) o por una vía "laparoscópica, mínimamente invasiva" (se introducen en la cavidad corporal instrumentos y cámaras a través de pequeñas heridas). </p>
			</div>
		</div>
	</section>
	...
	<section class="beneficios-cirugia">
		<div class="wrapt-beneficios-cirugia">
			<h2>Beneficios de la apendicectomía</h2>

			<article>
				<h3>Riesgos de no realizar la operación</h3>
				<p>Si el apéndice inflamado o infectado no recibe tratamiento, puede perforarse. Esta situación puede conducir al desarrollo de una infección potencialmente mortal en la cavidad abdominal.</p>
			</article>
			<article>
				<h3>beneficios de realizar la operación</h3>
				<p>Una apendectomía removerá el órgano infectado y aliviará el dolor. Una vez que el apéndice es removido, la apendicitis no volverá a ocurrir.</p>
			</article>
			<article>
				<h3>recuperación tras la operación</h3>
				<p>Si no tiene complicaciones, por lo general se le da alta del hospital en 1 ó 2 días luego de su cirugía laparoscópica o procedimiento abierto.</p>
			</article>
		</div>
	</section>
	<!--------------------- CIERRA DESCRIPCIÓN CIRUGÍA --------------------->
